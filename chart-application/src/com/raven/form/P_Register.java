...
public class P_Register extends javax.swing.JPanel {
    ...
    private void cmdRegisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdRegisterActionPerformed
        ...
        if (userName.equals("")) {
            JOptionPane.showMessageDialog(txtUser,"Vui lòng nhập username !");
            txtUser.grabFocus();
        } else if (password.equals("")) {
            JOptionPane.showMessageDialog(txtPass,"Vui lòng nhập Password !");
            txtPass.grabFocus();
        } else if (!password.equals(confirmPassword)) {
            JOptionPane.showMessageDialog(txtPass,"Nhập lại password chưa đúng!");
